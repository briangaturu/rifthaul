...
export default function AboutHero() {
  ...
  return (
    <section className="relative min-h-[60vh] flex flex-col justify-center px-4 sm:px-6 md:px-16 pt-28 sm:pt-32 pb-16 sm:pb-20 overflow-hidden">
      {/* Background */}
      ...
      <div ref={ref} className="reveal relative z-20 max-w-3xl mx-auto text-center">
        ...
        <h1 className="font-display text-4xl sm:text-5xl md:text-6xl font-extrabold leading-none tracking-tight text-white mb-4 sm:mb-6 px-4">
          Revolutionizing <span className="text-[#E8830A]">logistics</span><br className="hidden sm:block" />across Kenya
        </h1>

        <p className="text-[#8A95A3] text-base sm:text-lg leading-relaxed max-w-2xl mx-auto px-4">
          We're building the future of freight transport—connecting businesses with verified transporters through technology, transparency, and trust.
        </p>
      </div>
    </section>
  )
