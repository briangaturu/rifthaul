...
export default function AboutHero() {
  ...
  return (
    <section className="relative min-h-[60vh] flex flex-col justify-center px-6 md:px-16 pt-32 pb-20 overflow-hidden">
      {/* Background */}
      ...
      <div ref={ref} className="reveal relative z-20 max-w-3xl mx-auto text-center">
        ...
        <h1 className="font-display text-5xl md:text-6xl font-extrabold leading-none tracking-tight text-white mb-6">
          Revolutionizing <span className="text-[#E8830A]">logistics</span><br />across Kenya
        </h1>
